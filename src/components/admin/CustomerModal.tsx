        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground border-b pb-2">Profile Information</h3>
            ...
            {/* Section 2: Address */}
            <div className="space-y-4">
              <h3 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground border-b pb-2">Address</h3>
              <FormField
                control={form.control}
                name="address"
                render={({ field }) => (
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground border-b pb-2">Additional</h3>
              <FormField
                control={form.control}
                name="notes"
                render={({ field }) => (
