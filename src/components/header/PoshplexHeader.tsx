...
const PoshplexHeader = () => {
  ...
  return (
    <header className={`w-full sticky top-0 ${isCartOpen ? "z-[70]" : "z-50"} bg-background md:w-screen md:relative md:left-1/2 md:right-1/2 md:-ml-[50vw] md:-mr-[50vw]`} style={{ position: 'sticky' }}>
      <AnnouncementBar />
