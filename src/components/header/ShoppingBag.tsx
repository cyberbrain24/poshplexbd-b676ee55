...
const ShoppingBag = ({ isOpen, onClose, cartItems, updateQuantity, onViewFavorites }: ShoppingBagProps) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] h-screen">
      ...
      {/* Off-canvas panel */}
      <div className="absolute right-0 top-0 h-screen w-96 max-w-full bg-background border-l border-border animate-slide-in-right flex flex-col pb-20 lg:pb-0">
        {/* Header */}
            ...
            <>
              ...
              <div className="border-t border-border pt-6 space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-medium text-foreground">৳{subtotal.toLocaleString('en-BD', { minimumFractionDigits: 2 })}</span>
                </div>
