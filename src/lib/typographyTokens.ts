...
export const TYPO_DEFAULTS: Record<TypographyToken, TokenConfig> = {
  display:              { slot: "serif", weightDesktop: 400, weightMobile: 400, sizeDesktop: 48, sizeMobile: 32, lineHeight: 1.05, letterSpacing: -0.5, transform: "none" },
  h1:                   { slot: "serif", weightDesktop: 400, weightMobile: 400, sizeDesktop: 32, sizeMobile: 26, lineHeight: 1.1,  letterSpacing: 0,    transform: "none" },
  h2:                   { slot: "sans",  weightDesktop: 500, weightMobile: 500, sizeDesktop: 20, sizeMobile: 18, lineHeight: 1.25, letterSpacing: 0,    transform: "none" },
  h3:                   { slot: "sans",  weightDesktop: 500, weightMobile: 500, sizeDesktop: 15, sizeMobile: 15, lineHeight: 1.3,  letterSpacing: 0.3,  transform: "none" },
  "product-title-card": { slot: "sans",  weightDesktop: 400, weightMobile: 400, sizeDesktop: 14, sizeMobile: 14, lineHeight: 1.4,  letterSpacing: 0,    transform: "none" },
  "product-title-pdp":  { slot: "serif", weightDesktop: 400, weightMobile: 400, sizeDesktop: 22, sizeMobile: 20, lineHeight: 1.2,  letterSpacing: 0,    transform: "none" },
  price:                { slot: "sans",  weightDesktop: 500, weightMobile: 500, sizeDesktop: 18, sizeMobile: 16, lineHeight: 1.2,  letterSpacing: 0,    transform: "none" },
  "price-sale":         { slot: "sans",  weightDesktop: 500, weightMobile: 500, sizeDesktop: 18, sizeMobile: 16, lineHeight: 1.2,  letterSpacing: 0,    transform: "none" },
  "price-original":     { slot: "sans",  weightDesktop: 400, weightMobile: 400, sizeDesktop: 14, sizeMobile: 13, lineHeight: 1.2,  letterSpacing: 0,    transform: "none" },
  body:                 { slot: "sans",  weightDesktop: 400, weightMobile: 400, sizeDesktop: 15, sizeMobile: 15, lineHeight: 1.6,  letterSpacing: 0,    transform: "none" },
  "body-small":         { slot: "sans",  weightDesktop: 400, weightMobile: 400, sizeDesktop: 13, sizeMobile: 13, lineHeight: 1.5,  letterSpacing: 0,    transform: "none" },
  label:                { slot: "sans",  weightDesktop: 400, weightMobile: 400, sizeDesktop: 13, sizeMobile: 13, lineHeight: 1.4,  letterSpacing: 0,    transform: "none" },
  button:               { slot: "sans",  weightDesktop: 500, weightMobile: 500, sizeDesktop: 14, sizeMobile: 14, lineHeight: 1,    letterSpacing: 0.6,  transform: "uppercase" },
  "nav-link":           { slot: "sans",  weightDesktop: 500, weightMobile: 500, sizeDesktop: 14, sizeMobile: 15, lineHeight: 1,    letterSpacing: 0.4,  transform: "uppercase" },
  badge:                { slot: "sans",  weightDesktop: 500, weightMobile: 500, sizeDesktop: 11, sizeMobile: 11, lineHeight: 1,    letterSpacing: 0.6,  transform: "uppercase" },
  logo:                 { slot: "serif", weightDesktop: 400, weightMobile: 400, sizeDesktop: 24, sizeMobile: 20, lineHeight: 1,    letterSpacing: 1,    transform: "uppercase" },
  caption:              { slot: "sans",  weightDesktop: 400, weightMobile: 400, sizeDesktop: 12, sizeMobile: 12, lineHeight: 1.5,  letterSpacing: 0,    transform: "none" },
};
