  ...
  return (
    <>
      ...
      <MasterDataModal
        ...
        onSave={handleSave}
        title={selectedItem ? "Edit Care Instruction" : "Add Care Instruction"}
      ...
      <AlertDialog open={!!deleteItem} onOpenChange={() => setDeleteItem(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete "{deleteItem?.name}"? This may affect products using this instruction.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
