...
const AdminIncomeCategories = () => {
  ...
  const { data: categories = [], isLoading } = useTransactionCategories("income");
    ...
    <>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold">Income Categories</h1>
            <p className="text-muted-foreground">Manage income categories and sub-categories</p>
          </div>
        ...
        {isLoading ? (
          ...
          <Table>
            ...
            <TableBody>
              ...
              {/* Show categories without parent that aren't in parentCategories (orphans) */}
              {categories
                ...
                .map((orphan) => (
                  <TableRow key={orphan.id}>
                    ...
                    <TableCell className="text-right">
                      <div className="flex justify-end gap-2">
                        <Button variant="ghost" size="icon" onClick={() => handleEdit(orphan)}>
                          <Edit className="h-4 w-4" />
                        </Button>
                        <Button variant="ghost" size="icon" onClick={() => setDeleteId(orphan.id)}>
                          <Trash2 className="h-4 w-4" />
                        </Button>
                      </div>
                    </TableCell>
